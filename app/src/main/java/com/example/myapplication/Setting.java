...
public class Setting extends AppCompatActivity {
     ...
     */
    final static String TOKEN = "com.example.myapplication.ClientConnections";
    ...
    /**
     * {@link Setting.ChangeListener} for use with all {@link Connection} objects created by this instance of <code>ClientConnections</code>
     */
    private Setting.ChangeListener changeListener = new Setting.ChangeListener();

    /**
     * This instance of <code>ClientConnections</code> used to update the UI in {@link Setting.ChangeListener}
     */
    private Setting clientConnections = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener(new Setting.LongClickItemListener());
    ...
    private void createAndConnect()
    {
        ...
        createConnection.setClassName(
                ...
                "com.example.myapplication.NewConnectionActivity");
